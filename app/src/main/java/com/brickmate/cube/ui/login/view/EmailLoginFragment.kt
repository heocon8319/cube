...
class EmailLoginFragment : BaseFragment() {
    ...
    override fun layoutId() = R.layout.fragment_email_login
    ...
    private fun initListener() {
        val emailForgotFrag = EmailForgotPasswordFragment.newInstance()
        tvForgotPassword.setOnClickListener {
            navigateToFragment(emailForgotFrag, emailForgotFrag.TAG())
        }
    }

    override fun onNextArrowPressed() {
        super.onNextArrowPressed()
        val fragDes = NickNameFragment.newInstance()
