 ...
 */
class EmailRegisterFragment : BaseFragment() {
    ...
    override fun layoutId() = R.layout.fragment_email_register
    ...
    companion object {
        ...
        fun newInstance(): EmailRegisterFragment = EmailRegisterFragment()
    }
}