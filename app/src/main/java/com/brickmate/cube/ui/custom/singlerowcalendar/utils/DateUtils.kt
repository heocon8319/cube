package com.brickmate.cube.ui.custom.singlerowcalendar.utils
...
object DateUtils {
    ...
    /**
     * @param date - which we want simple name from
     * @return full day "dd/MM/yyyy"
     */
    fun getDayNameSimple(date: Date): String =
