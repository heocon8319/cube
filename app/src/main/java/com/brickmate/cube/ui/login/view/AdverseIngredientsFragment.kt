 ...
 * Use the [AdverseIngredientsFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class AdverseIngredientsFragment : BaseFragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment AdverseIngredientsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            AdverseIngredientsFragment().apply {
        ...
        fun newInstance(): AdverseIngredientsFragment = AdverseIngredientsFragment()
    }
}